...
arch = [
    ...
    to_Conv("conv1", 112, 64, offset="(0,0,0)", to="(0,0,0)", height=32, depth=32, width=2, caption="7x7 conv" ),
    #block_Res(4, "basic_block", 'conv1', 'poo1'),
    to_Pool("pool1", offset="(0,0,0)", to="(conv1-east)"),
    to_Conv("conv2", 56, 64, offset="(1,0,0)", to="(pool1-east)", height=28, depth=28, width=2, caption="basic block1" ),
    #to_connection( "pool1", "conv2"),
    to_Pool("pool2", offset="(0,0,0)", to="(conv2-east)", height=28, depth=28, width=2),
    to_Conv("conv3", 28, 128, offset="(1,0,0)", to="(pool2-east)", height=24, depth=24, width=4, caption="bb2" ),
    to_Pool("pool3", offset="(0,0,0)", to="(conv3-east)", height=24, depth=24, width=1),
    to_Conv("conv4", 14, 256, offset="(1,0,0)", to="(pool3-east)", height=20, depth=20, width=8, caption="bb3" ),
    to_Pool("pool4", offset="(0,0,0)", to="(conv4-east)", height=20, depth=20, width=1),
    to_Conv("conv5", 7, 512, offset="(1,0,0)", to="(pool4-east)", height=16, depth=16, width=16, caption="bb4" ),
    ...
    to_SoftMax("soft2", 7 ,"(3,0,0)", "(soft1-east)", width=6, caption="Output parameters"  ),
